                ...
                action.setCallback(this, function(response){
                    ...
                    if(stateResponse === 'SUCCESS' || stateResponse === 'DRAFT'){
                        ...
                        for(var key in resultData){
                            ...
                            if(subTotal){
                                subTotal = subTotal + resultData[key].Item_Amount__c
                                // alert(resultData[key].Item_Amount__c)
                            }
                            else
                                subTotal = resultData[key].Item_Amount__c;
                            //  console.log(resultData[key].Item_Amount__c);
                        }
                        //  alert(subTotal)
